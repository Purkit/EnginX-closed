...
namespace enginx
{
    class WaylandWindow : public ExWindow
    {
        public:
            WaylandWindow(u32 width, u32 height, const std::string& title);
            //WaylandWindow(const ExWindowConfigInfo& window_configuration);
